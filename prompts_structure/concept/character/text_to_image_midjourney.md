...
| **Personality-to-Visual** | Body language, hand state, signature gesture, contrast shot | Use the translation table in `core-t2i.md`. EVERY personality trait becomes a visible cue. A loyal character's body angles slightly forward like a shield. A gentle giant's fingers are half-curled and relaxed. |
