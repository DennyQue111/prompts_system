...
[Posture] +
[Layout instruction: 16:9 concept design sheet, clean near-white background, subtle paper texture, thin dark panel dividers, exact grid positions from general_layout_instruction.md in this directory]
```
...
5. **Layout reference**: `general_layout_instruction.md` in this directory
