...
4. **Respect user content override.** If the user says "apply this style to Scene 01 — suburban ring road at midnight," the scene geography and architecture come from the user's description. The rendering style comes from Step 2 analysis of the reference.
