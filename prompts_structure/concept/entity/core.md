...
- A supported renderer handles geometric precision well (spheres, crystals, floating structures) — lean into precise form descriptions.
...
→ **`general_layout_instruction.md`** in this directory
