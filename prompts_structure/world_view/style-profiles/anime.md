...
**Note on Niji**: `--niji 6` produces purer anime/illustration output. For Gantz × Demon Slayer fusion, `--v 8.2` is recommended — it better handles the hybrid of hard realism (Gantz) and expressive anime (Demon Slayer). If results are too photographic, switch to `--niji 6`.
