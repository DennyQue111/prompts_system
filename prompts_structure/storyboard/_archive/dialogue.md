> **⚠️ ARCHIVED** — Content merged into `gemini.md` → Scene-Type Specializations → Dialogue Scenes.
> This file is kept for reference only. All updates should go to `gemini.md`.
